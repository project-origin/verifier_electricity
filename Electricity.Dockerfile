...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/dotnet/sdk:9.0.307 AS build
ARG PROJECT
...
# ------- production image -------
FROM mcr.microsoft.com/dotnet/aspnet:10.0.11-noble-chiseled-extra AS production
