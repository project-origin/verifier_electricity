...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/dotnet/sdk:9.0.203 AS build
ARG PROJECT
...
# ------- production image -------
FROM mcr.microsoft.com/dotnet/aspnet:9.0.5-noble-chiseled-extra AS production
